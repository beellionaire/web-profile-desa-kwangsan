...
Route::get('/profil-desa', [ProfilDesaController::class, 'index'])->name('profilDesa.index');
...
Route::get('/potensi/{slug}', [PotensiController::class, 'detail'])->name('potensi.detail');
...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware('admin')->group(function () {
        ...
        // Potensi
        Route::get('/potensi', [PotensiController::class, 'potensiAdmin'])->name('potensiAdmin');
        Route::get('/potensi/create', [PotensiController::class, 'potensiAdminCreate'])->name('potensi.create');
        Route::post('/potensi', [PotensiController::class, 'potensiAdminStore'])->name('potensi.store');
        Route::get('/potensi/{id}/edit', [PotensiController::class, 'potensiAdminEdit'])->name('potensi.edit');
        Route::put('/potensi/{id}', [PotensiController::class, 'potensiAdminUpdate'])->name('potensi.update');
        Route::get('/potensi/{id}', [PotensiController::class, 'potensiAdminDetail'])->name('potensi.detail');
        Route::delete('/potensi/{id}', [PotensiController::class, 'potensiAdminDestroy'])->name('potensi.destroy');
    });
});
